        ...
        *,
        ...
        if language in ("python3", "python"):
            ...
            _TEMPLATE = (
                ...
                '                        _result_set = False\n'
                '                        _last_exc = None\n'
                '                        if not _result_set and _pk_kw and all(k in _inp_kw for k in _pk_kw):\n'
                '                            try:\n'
                ...
                '                        if not _result_set and _pk_kw and all(k in _inp_kw for k in _pk_kw):\n'
                '                            try:\n'
                '                                result = target(*[_inp_kw[k] for k in _pk_kw])\n'
                '                                _result_set = True\n'
                '                            except Exception as _e:\n'
                '                                _last_exc = _e\n'
                '                        if not _result_set and _pk_kw:\n'
                '                            try:\n'
                '                                _vals = list(_inp_kw.values())\n'
                '                                if len(_vals) == len(_pk_kw):\n'
                '                                    result = target(*_vals)\n'
                '                                    _result_set = True\n'
                '                            except Exception as _e:\n'
                '                                _last_exc = _e\n'
